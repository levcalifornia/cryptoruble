...
"systcrutl daemon-reload" in order to update running systemd configuration.

To test, run "systcrutl start bitcoind" and to enable for system startup run
"systcrutl enable bitcoind"
