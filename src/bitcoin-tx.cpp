...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Cryptoruble Core cryptoruble-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  cryptoruble-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cryptoruble transaction") + "\n" +
              "  cryptoruble-tx [options] -create [commands]   " + _("Create hex-encoded cryptoruble transaction") + "\n" +
              "\n";
