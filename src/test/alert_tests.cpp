...
BOOST_AUTO_TEST_CASE(AlertApplies)
{
    ...
    // cryptoruble: TODO: sign alerts with cryptoruble key
...
//    }
    ...
    // Matches:
    // cryptoruble: for some bitcoin test alerts are read with nExpiration == 0, making following tests fail.
...
BOOST_AUTO_TEST_CASE(AlertNotify)
{
    ...
    // cryptoruble: following tests requires alertnotify.txt to exist, but for some reason this file is deleted at next instruction...
